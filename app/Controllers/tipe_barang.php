...
class tipe_barang extends BaseController
{
    ...
    public function Simpan()
    {
        if (!$this->validate([
            ...
            return redirect()->to('tipe_barang/' .  $this->request->getVar('id_barang'))->withInput();
        }
        ...
        return redirect()->to('tipe_barang/' .  $this->request->getVar('id_barang'));
    }
    ...
    public function Hapus()
    {
        ...
        return redirect()->to('tipe_barang/' . $id_barang);
    }
