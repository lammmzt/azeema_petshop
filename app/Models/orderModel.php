...
class orderModel extends Model
{
    ...
    protected $allowedFields = ['id_order','id_user', 'tanggal_order', 'tanggal_proses', 'tanggal_datang', 'jam_datang','tipe_pembayaran', 'bukti_pembayaran', 'total_order', 'ket_order', 'status_order' ];
