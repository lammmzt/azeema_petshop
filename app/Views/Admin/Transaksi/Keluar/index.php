    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="<?= base_url('Transaksi/tambah_transaksi_keluar'); ?>"
                    class="btn btn-primary btn-sm float-right"><i class="fa fa-plus"></i></a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-responsive-sm text-black-50" id="tabel_transaksi_keluar">
                        <thead>
                            <tr>
                                <th>#</th>
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($transaksi_keluar as $key => $value) : ?>
                            <tr>
                                <td><?= $no++; ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('Transaksi/print_struk/' . $value['id_transaksi']); ?>"
...
<!-- detail -->
<?php foreach ($transaksi_keluar as $key => $value) : ?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="merk_transaksi_keluar" class="form-control"
